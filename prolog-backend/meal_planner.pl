...
generate_meals(5, (DPL, DCL, DFL, DCalL), (DPR, DCR, DFR, DCalR), Answer) :-
				...
				append([('one', Protein1, Carbs1, Fats1, Calories1, SingleMeal1)], [(Protein2, Carbs2, Fats2, Calories2, SingleMeal2)], SingleMeal12),
				...
				append(SingleMeal1234, [(Protein5, Carbs5, Fats5, Calories5, SingleMeal5)], Res2),

				random_permutation(Res2, Res),
